...
//   };
//   render() {
//     const {type,label,name,options} = this.props;
//     return (
//       <Fragment>
//         <Form layout="inline" onFinish={this.onSubmit}>
//           {/* keyword input */}
//           <Form.Item label={lable} name={name}>
...
// // export default connect(mapStateToProps, mapDispatchToProps)(FormSearch);//connect the mapStateToProps, mapDispatchToProps together
